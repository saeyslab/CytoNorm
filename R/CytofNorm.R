...
#' the wrapper function \code{\link{CytofNorm.train}} instead.
#'
...
#' @seealso   \code{\link{QuantileNorm.train}}, \code{\link{CytofNorm.normalize}},
#'            \code{\link{prepareFlowSOM}}
#'
#' @examples
#'
#' @export
CytofNorm.train <- function(files,
                            labels,
                            channels,
                            transformList,
                            outputDir = "./tmp",
    ...
    # Compute clustering
    if (plot) {
        grDevices::pdf("CytofNorm_FlowSOM.pdf", height=15, width=20)
    }


    nCells <- FlowSOM.params[["nCells"]]
    FlowSOM.params <- FlowSOM.params[grep("nCells",
...
#'         directory
#' @seealso   \code{\link{CytofNorm.train}}
#'
#' @examples
#'
#' @export
CytofNorm.normalize <- function(model,
                                files,
                                labels,
                                transformList,
